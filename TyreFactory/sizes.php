...
if(isset($_SESSION['success']))
{
 ...
 echo 'alert("Tyre Size Added Successfully")';
 echo '</script>'; 
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4><i class="micon dw dw-table mtext"></i>Tyre Sizes</h4>
							</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Tyre Size List</h4>
					</div>
					<div class="pb-20">
							<table class="data-table table responsive">
								...
								<tbody>
									...
									<tr>
										<?php $i++;
                                        $_SESSION['size_Id']=$result['size_Id']; 
										...
										<td>
											<div class="dropdown">
												...
												{ ?>
											    <a class="dropdown-item" href="viewsize.php?size_Id=<?php echo $result['size_Id'];?>"><i class="dw dw-eye"></i>View</a>
												<?php } ?>
												<?php
												include('connection.php');
												if( session_id()=='')
												...
												if($users1=="tbladmin")
												{ ?>
													<a class="dropdown-item" href="updatesize.php?size_Id=<?php echo $result['size_Id'];?>"><i class="dw dw-edit2"></i> Edit</a>
									...
									<div class="modal-content">
										<div class=" border-radius-10">
											<div class="login-title"><br>
												<div class="col-md-12 col-sm-12 mb-30">
												<h2 class="text-center text-primary">Add Tyre Size</h2>
												</div>
											<form>
												...
												<div class="col-md-6 col-sm-12">
													<div class="form-group">
																<label>Size</label>
																<input class="form-control form-control-lg" required type="text" name="sizename">
															</div>
												</div>
								...
								<div class="modal-dialog modal-sm modal-dialog-centered">
									<div class="modal-content bg-danger text-white">
										<div class="modal-body text-center">
											...
											<button type="button" onclick="location.href='delsize.php?size_Id=<?php echo $sizeid;?>'" class="btn btn-light" data-dismiss="modal">Yes</button>
