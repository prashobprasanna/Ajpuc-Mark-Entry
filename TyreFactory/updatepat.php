...
{
  $pattern=$_SESSION['pattern_Id'];
  $name=$_POST['patname'];
  $desc=$_POST['desc'];
  
   $sql="update tbltyrepattern set patternName='$name', Description='$desc' where pattern_Id=$pattern_Id";
...
<?php
                    ...
                    $i=1;
                    $_SESSION['pattern_Id']=$pattern_Id;
                    $sql=mysqli_query($con,"SELECT * FROM tbltyrepattern where pattern_Id=$pattern_Id");
                            ...
                            <div class="input-group custom">
												<div class="col-md-6 col-sm-12">
													<div class="form-group">
																...
																<input class="form-control form-control-lg" type="text" name="patname"  value="<?php echo $result['patternName']?>">
															</div>
												</div>
