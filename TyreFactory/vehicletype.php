...
<div class="header">
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4><i class="micon dw dw-table mtext"></i>Vehicle Types</h4>
							</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Vehicle Types List</h4>
					</div>
					<div class="pb-20">
							<table class="data-table table responsive">
								...
								<tbody>
									...
									<tr>
										<?php $i++;
                                        $_SESSION['vehicletype_id']=$result['vehicletype_id']; 
										$vtypeid=$result['vehicletype_id'];
                                        ?>
										<td><?php echo $result['vehicletype_id'];  ?></td>
										...
										<td>
											<div class="dropdown">
												...
												{ ?>
											    <a class="dropdown-item" href="viewvtype.php?vehicletype_id=<?php echo $result['vehicletype_id'];?>"><i class="dw dw-eye"></i>View</a>
												<?php } ?>
												<?php
												include('connection.php');
												if( session_id()=='')
												...
												if($users1=="tbladmin")
												{ ?>
													<a class="dropdown-item" href="updatevtype.php?vehicletype_id=<?php echo $result['vehicletype_id'];?>"><i class="dw dw-edit2"></i> Edit</a>
	...
	<!-- Add Item -->
	<form action="addvtype.php" method="post">
									...
									<div class="modal-content">
										<div class=" border-radius-10">
											<div class="login-title"><br>
												<div class="col-md-12 col-sm-12 mb-30">
												<h2 class="text-center text-primary">Add Vehicle Type</h2>
												</div>
											<form>
												...
												<div class="col-md-6 col-sm-12">
													<div class="form-group">
																...
																<input class="form-control form-control-lg" required type="text" name="vtypename">
															</div>
												</div>
												...
												<div class="col-md-12 col-sm-12">
													<div class="form-group">
																...
																&nbsp;<a href="vehicletype.php"> <i class="dw dw-left-arrow-5" style="font-size: 2em;"></i> </a>
															</div>
												</div>
												</div>
											</form>
								...
								<div class="modal-dialog modal-sm modal-dialog-centered">
									<div class="modal-content bg-danger text-white">
										<div class="modal-body text-center">
											...
											<button type="button" onclick="location.href='delvtype.php?vehicletype_id=<?php echo $vtypeid?>'" class="btn btn-light" data-dismiss="modal">Yes</button>
