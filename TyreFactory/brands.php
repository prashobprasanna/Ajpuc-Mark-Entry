		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4><i class="micon dw dw-table mtext"></i>Tyre Brands</h4>
							</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Tyre Brands List</h4>
					</div>
					<div class="pb-20">
									...
									<tr>
										...
										<td>
											<div class="dropdown">
												...
												{ ?>
											    <a class="dropdown-item" href="viewbrand.php?company_Id=<?php echo $result['company_Id'];?>"><i class="dw dw-eye"></i>View</a>
												<?php } ?>
												<?php
												include('connection.php');
												if( session_id()=='')
												...
												if($users1=="tbladmin")
												{ ?>
													<a class="dropdown-item" href="updatebrand.php?company_Id=<?php echo $result['company_Id'];?>"><i class="dw dw-edit2"></i> Edit</a>
									...
									<div class="modal-content">
										<div class=" border-radius-10">
											<div class="login-title"><br>
												<div class="col-md-12 col-sm-12 mb-30">
												<h2 class="text-center text-primary">Add Tyre Brand</h2>
												</div>
											<form>
												...
												<div class="col-md-6 col-sm-12">
													<div class="form-group">
																...
																<input class="form-control form-control-lg" required type="text" name="brandname">
															</div>
												</div>
								...
								<div class="modal-dialog modal-sm modal-dialog-centered">
									<div class="modal-content bg-danger text-white">
										<div class="modal-body text-center">
											...
											<button type="button" onclick="location.href='delbrand.php?company_Id=<?php echo $compid?>'" class="btn btn-light" data-dismiss="modal">Yes</button>
