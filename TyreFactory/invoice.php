				...
				<div class="page-header">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4><i class="micon dw dw-table mtext"></i> Invoice</h4>
							</div>
							...
							<table class="data-table table responsive">
								...
								<tbody>
									<?php
										...
										$i=1;
										$sql=mysqli_query($con,"SELECT * FROM tblinvoice i,tblsupplier s, tblitem im where i.Sup_Id=s.Sup_Id and i.itemId=im.itemId");
									...
									<tr>
                                        ...
                                        ?>
                                        <td><?php echo $result['invoice_id'];?>
										<td><?php echo $result['Sup_Name'];?>
										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<a class="dropdown-item" href="editinvoice.php?itemId=<?php echo $result['invoice_id'];?>"><i class="dw dw-edit2"></i> Edit</a>
									...
									<div class="modal-content">
										<div class=" border-radius-10">
											<div class="login-title"><br>
												<div class="col-md-12 col-sm-12 mb-30">
												<h2 class="text-center text-primary">Add Invoice</h2>
												</div>
											<form>
												...
												<div class="col-md-6 col-sm-12">
													<div class="form-group">
																...
																<select class="form-control form-control-lg" required type="text" name="supplier">
																<?php
															session_start();
															extract($_REQUEST);
															include("connection.php");
															...
															{
															?>
															<option value="<?php echo $result['Sup_Id'];?>"><?php echo $result['Sup_Name'];?></option>
															<?php } ?>
																</select>
															</div>
												</div>
												<div class="col-md-12 col-sm-12">
													<div class="form-group">
																<label>Item Id</label>
																<select type="text" class="form-control form-control-lg" required name="itemid">
																<?php
															session_start();
															extract($_REQUEST);
															include("connection.php");
												...
												<div class="col-md-6 col-sm-12">
													<div class="form-group">
																...
																<input class="form-control form-control-lg" required type="text" name="quantity">
															</div>
												</div>
												<div class="col-md-6 col-sm-12">
													<div class="form-group">
																<label>Price</label>
																<input class="form-control form-control-lg" required type="text" name="price">
															</div>
												</div>
												<div class="col-md-12 col-sm-12">
													<div class="form-group">
																<input type="submit" class="btn btn-primary" value="Submit" name="addInvoice"></br></br>
								...
								<div class="modal-dialog modal-sm modal-dialog-centered">
									<div class="modal-content bg-danger text-white">
										<div class="modal-body text-center">
											...
											<button type="button" onclick="location.href='delInvoice.php?invoice_id=<?php echo $invoiceid?>'" class="btn btn-light" data-dismiss="modal">Yes</button>
