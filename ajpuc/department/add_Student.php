          ...
          <div class="col-md-6 col-sm-4 col-sx-12">
            ...
            <div class="kv-avatar center-block" style="width:200px">
                ...
                class="file-loading">
                     ...
                     <div class="form-group">
                        <div class="col-md-4 col-sm-4 col-sx-12">
                           <label for="name" class="control-label">USN </label><span id="sp">:</span> <span style="color:#f00">*</span>
                        </div>
                        <div class="col-md-6 col-sm-6 col-sx-12">
 ...
 <label><input type="radio"  name="sec" value="f">F</label>
                    ...
                    <div class="form-group" id="cyclehide" style="display:none">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <div class="col-md-4 col-sm-4 col-sx-12">
                           <label for="name" class="control-label">Name of Parent/Guardian </label><span id="sp">:</span> <span style="color:#f00">*</span>
                        </div>
                        <div class="col-md-6 col-sm-6 col-sx-12">
